...
app.controller('PieController', ['$scope','$http', 'uiGridConstants', 'sharedService', 'state', 'globalData', 
...
$scope.$on('onChargeDateChanged', function() {
        ...
        if(sharedService.isWidgetShown($scope.widgetId)) {
            $scope.generatePie();
        }
